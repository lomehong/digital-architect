...
> **部署前提（显式化，2026-09-12）**：当前平台**随大脑仓部署**——平台代码、知识治理、配置、数据根都在仓内，仓在哪平台在哪。大脑仓多副本/平台独立部署的演进方案见 `docs/designs/2026-09-12-平台独立部署演进-技术方案.md`（Model B：打包解耦 / 配置迁数据根 / 大脑仓 git 镜像 / governor 远端执行面，待主人确认后分期实施）。
